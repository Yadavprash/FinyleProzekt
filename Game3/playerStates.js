...
export class Sitting extends State {
  ...
  handleInput(input) {
    if (input.includes('ArrowDown')) {
      ...
      this.game.player.setStates(states.ROLLING, 2.5);
    }
  }
}
...
export class Jumping extends State {
  ...
  enter() {
    ...
    if (this.game.player.onGround()) this.game.player.vy -= 19;
    else this.vy = 0;
  }
  handleInput(input) {
  ...
  handleInput(input) {
    this.game.particles.unshift(
      new Fire(
        ...
        this.game.player.y + this.game.player.height * 0.55
      )
    );
